...
model_functions = {
    model: re.sub(f"[{string.punctuation}]", "_", model) for model in _available_models()
}
...
_entrypoints = {
    model_functions[model]: _create_hub_entrypoint(model) for model in _available_models()
}
